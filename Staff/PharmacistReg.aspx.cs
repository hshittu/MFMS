...
public partial class Staff_PharmacistReg : BasePage
{
    ...
    private void Email_Send()
    {
        ...
        string queryString = "select PharmacistId from tblPharmacists where [FirstName]='" + @FirstName + "' and [LastName]='" + @LastName + "';";
        ...
        using (SqlCommand command = new SqlCommand(queryString, connection))
        {
            ...
            using (SqlDataReader reader = command.ExecuteReader())
            {
                ...
                reader.Read();
                PharmacistId = reader.GetInt32(0);
        ...
        try
        {
            ...
            MyMessage.Body = "Hello '" + @FirstName + "' '" + @LastName + "', You are welcome to Medical Facility Management System, You have been Registered as a new Pharmacist. Your ID is '" + @PharmacistId + "'";
