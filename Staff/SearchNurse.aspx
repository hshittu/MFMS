<%@ Page Title="Search Nurses" Language="C#" MasterPageFile="~/Masterpages/Frontend.master" AutoEventWireup="true" CodeFile="SearchNurse.aspx.cs" Inherits="Staff_SearchNurse" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpMainContent" Runat="Server">
     <script type="text/javascript">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:MFMSconnectionstring %>" SelectCommand="SELECT [FirstName], [LastName], [Age], [Sex], [RegistrationDate], [Address], [Email], [PhoneNumber] FROM [tblNurses] WHERE (([FirstName] = @FirstName) AND ([LastName] = @LastName))">
            <SelectParameters>
