<%@ Page Title="Search Doctors" Language="C#" MasterPageFile="~/Masterpages/Frontend.master" AutoEventWireup="true" CodeFile="SearchDoctor.aspx.cs" Inherits="Staff_SearchDoctor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpMainContent" Runat="Server">
    ...
    <asp:Button ID="ExportButton" runat="server" Text="Export Report" />
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:MFMSconnectionstring %>" SelectCommand="SELECT [FirstName], [LastName], [PhoneNumber], [EmergencyNumber], [Sex], [DoctorCost], [RegistrationDate], [Email], [Address], [ConsultationDays] FROM [tblDoctors] WHERE (([FirstName] = @FirstName) AND ([LastName] = @LastName))">
    <SelectParameters>
