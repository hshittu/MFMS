<%@ Page Title="View all Pharmacists" Language="C#" EnableEventValidation="false" MasterPageFile="~/Masterpages/Frontend.master" AutoEventWireup="true" CodeFile="AllPharmacists.aspx.cs" Inherits="Staff_AllPharmacists" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpMainContent" Runat="Server">
    ...
    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" DataKeyNames="PharmacistId" DataSourceID="SqlDataSource1" CellSpacing="2" ForeColor="Black">
        <Columns>
    ...
    <asp:Button ID="btnPDFExport" runat="server" Text="Export to PDF" OnClick="btnPDFExport_Click" />
     <asp:Button ID="btnRBview" runat="server" PostBackUrl="~/Staff/PharmacistRBview.aspx" Text="View All Data on Report Viewer" />
