<%@ Page Title="Register Recetionist" Language="C#" MasterPageFile="~/Masterpages/Frontend.master" AutoEventWireup="true" CodeFile="ReceptionistReg.aspx.cs" Inherits="Staff_ReceptionistReg" %>

<%--<%@ Register src="../Controls/PharmacistReg.ascx" tagname="PharmacistReg" tagprefix="uc1" %>

<%@ Register src="../Controls/ReceptionistReg.ascx" tagname="ReceptionistReg" tagprefix="uc2" %>--%>
...
<table class="auto-style1">
    <tr>
        <td colspan="3"><p>Register Receptionist</p></td>
    </tr>
    <tr>
        <td>&nbsp;First Name</td>
        <td>
