<%@ Control Language="C#" AutoEventWireup="true" CodeFile="DoctorRegistration.ascx.cs" Inherits="Controls_DoctorRegistration" %>
<style type="text/css">
    .auto-style1 {
        width: 100%;
    }
...
<table class="auto-style1">
    <tr>
        <td colspan="3">This Form is used to Register in New Doctors into MFMS application System.Remains a Property of Goodkiiiid</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td class="auto-style2">
            <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ControlToValidate="txtConsultationDays" CssClass="ErrorMessage" Display="Dynamic" ErrorMessage="Enter Consultation Days">*</asp:RequiredFieldValidator>
        </td>
    </tr>
    <tr>
        <td class="auto-style2">
