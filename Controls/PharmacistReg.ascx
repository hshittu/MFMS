<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PharmacistReg.ascx.cs" Inherits="Controls_PharmacistReg" %>
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
<table class="auto-style1">
    <tr>
        <td colspan="3">This Form is used to Register in New Pharmacists into MFMS application System.Remains a Property of Goodkiiiid</td>
    </tr>
    <tr>
        <td>&nbsp;First Name</td>
        <td>
