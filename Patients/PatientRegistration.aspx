<%@ Page Title="Patient Registration" Language="C#" MasterPageFile="~/Masterpages/Frontend.master" AutoEventWireup="true" CodeFile="PatientRegistration.aspx.cs" Inherits="Patients_PatientsRegistraton" %>
...
<table class="auto-style1">
    <tr>
        <td colspan="3" class="auto-style3"><p>Register Patient</p></td>
    </tr>
    <tr>
        <td>First Name</td>
        <td>
